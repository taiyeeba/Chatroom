...
.submit{
	...
	<body bgcolor="#E6E6FA">
	<center>
        <h1>Profile CRUD operations</h1>
		<form id="form" method="post">
		<table id="t01">
			<tr>
				<th>User Name: </th>
				<td><p id="p1"></p></td>
				<td colspan="2"><input class="button" type="button" onClick="changeUserName()" value="Edit"></td>
			</tr>
			<tr>
				<th>First Name: </th>
				<td><p id="p2"></p></td>
				<td colspan="2"><input type="button" class="button" onClick="changeFirstName()" value="Edit"></td>
			</tr>
			<tr>
				<th>Last Name: </th>
				<td><p id="p3"></p></td>
				<td colspan="2"><input type="button" class="button" onClick="changeLastName()" value="Edit"></td>
			</tr>
			<tr>
				<th>Mobile Number: </th>
				<td><p id="p4"></p></td>
				<td colspan="2"><input type="button" class="button" onClick="changeMobNo()" value="Edit"></td>
			</tr>
			<tr>
				<th>Email ID: </th>
				<td><p id="p5"></p></td>
				<td colspan="2"><input type="button" class="button" onClick="changeEmail()" value="Edit"></td>
			</tr>
			<tr>
				<th>Password: </th>
				<td><p id="p6"></p></td>
				<td colspan="2"><input type="button" class="button" onClick="changePassword()" value="Edit"></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="Submit" class="submit" onclick="submitForm('updateSave.php')" value="Save"></td>
				<td colspan="2" align="center"><input type="button" class="button" onclick="delConfirm()" value="Delete"></td>
			</tr>
		</table>
